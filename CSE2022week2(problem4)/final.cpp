...
int main(void) {
	...
	/* Bluebox*/
	for (int i = 0; i < 10; i++)
		my_objects1[i] = new GeometricObject(10 + (i - 0) * 120, 230, 130 + (i - 0) * 120, 360);
	for (int i = 10; i < 20; i++)
		my_objects1[i] = new GeometricObject(10 + (i - 10) * 120, 30, 130 + (i - 10) * 120, 160);
